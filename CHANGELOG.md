...
- build(build): prevent stale stage auto-resume after candidate heads (478a726909c7)
- build(build): allow retained production aliases during staging (57d0c5d35df0)
- build(build): deduplicate Railway API services and enforce canonical (3a1d458d858d)

## [0.6.54] - 2026-07-14

### Fixed

- build(build): fix release image state and atomic lockfiles (c483324d6c03)
...
- build(build): retain declared sibling operations runner resources (5802bb16caca)
- build(build): reattach production Railway domains to exact desired (e7b21d1a3814)

## [0.6.50] - 2026-07-13

### Dependencies

- build(build): discover Railway sibling identities without production (428572bfe607)
- build(build): retain sibling Railway environments during production (ecce1bec8a67)

## [0.6.49] - 2026-07-13

### Fixed

- build(build): Fix release readiness and merged branch cleanup (d062afcda5dd)

### Dependencies

- build(build): Retry transient GitHub job setup failures once (e682f193b0cd)
- build(build): Avoid repeated fetches during merged branch cleanup (71910bf9aad1)
- build(build): Delete merged feature branches after successful stage (d11ecace0ebf)
- build(build): Require explicit workflow resume and prevent stale (3f28facdb655)
- build(build): Permanently isolate Railway staging Git sources (85299683ffa8)
