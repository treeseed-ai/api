...
export function serializeCapacityReservationRow(row: Row | null): CapacityReservation | null {
	...
	return {
		...
		requestedSeconds: number(row, 'requested_seconds')!, reservedSeconds: number(row, 'reserved_seconds')!, activeSeconds: number(row, 'active_seconds')!,
		elapsedSeconds: number(row, 'elapsed_seconds')!, releasedSeconds: number(row, 'released_seconds')!, overrunSeconds: number(row, 'overrun_seconds')!, nativeUnit: nullableText(row, 'native_unit'),
