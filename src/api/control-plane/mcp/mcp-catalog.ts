...
export const mcpCatalog: McpCatalog = {
	schemaVersion: 'treeseed.mcp-catalog/v1',
	protocolVersion: MCP_PROTOCOL_VERSION,
	tools: buildMcpTools([...controlPlaneOperations.catalog.operations]),
	resources: [{
...
export function mcpCatalogDigest(catalog: McpCatalog = mcpCatalog) {
