...
export const SDK_METHOD_ROUTE_MAP = {
	archiveProject: 'post.v1.projects.projectId.archive',
	restoreProject: 'post.v1.projects.projectId.restore',
    ...
    restoreTeam: 'post.v1.teams.teamId.restore',
    teamDeletionReadiness: 'get.v1.teams.teamId.deletion-readiness',
    deleteTeamPermanently: 'delete.v1.teams.teamId.permanent-delete',
    ...
    assignmentAuthorityProbe: 'get.v1.teams.teamId.capacity.assignments.assignmentId.authority-probe',
    ...
    checkProjectContextQuery: 'post.v1.teams.teamId.projects.projectId.context-query-checks',
    projectContextQueryChecks: 'get.v1.teams.teamId.projects.projectId.context-query-checks',
    planAgentDeployment: 'post.v1.teams.teamId.agent-deployments.plan',
    executeAgentDeployment: 'post.v1.teams.teamId.agent-deployments.execute',
    agentDeployment: 'get.v1.teams.teamId.agent-deployments.deploymentId',
    activateAgentDeployment: 'post.v1.teams.teamId.agent-deployments.deploymentId.activate',
    upgradeAgentDeployment: 'post.v1.teams.teamId.agent-deployments.deploymentId.upgrade',
    ...
    preflightWorkdayRun: 'post.v1.teams.teamId.workday-runs.preflight',
    ...
    closeWorkdayAdmission: 'post.v1.teams.teamId.workday-runs.runId.close-admission',
    ...
    agentLabWorkdayContext: 'get.v1.teams.teamId.agent-lab.workday-context',
    agentLabOverview: 'get.v1.teams.teamId.agent-lab.overview',
    agentLabActivity: 'get.v1.teams.teamId.agent-lab.activity',
    agentLabMetricSeries: 'get.v1.teams.teamId.agent-lab.metric-series',
    agentLabEntities: 'get.v1.teams.teamId.agent-lab.entities',
    updateAgentLabTargets: 'patch.v1.teams.teamId.agent-lab.targets',
    ...
    abandonAssignmentContent: 'post.v1.teams.teamId.capacity.assignments.assignmentId.content-abandonment',
    integrateAssignmentContent: 'post.v1.teams.teamId.capacity.assignments.assignmentId.content-integration',
