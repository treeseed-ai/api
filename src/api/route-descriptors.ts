...
export const SDK_METHOD_ROUTE_MAP = {
	...
	workdayTestRuns: 'get.v1.teams.teamId.workday-tests',
	createWorkdayTestRun: 'post.v1.teams.teamId.workday-tests',
	workdayTestRun: 'get.v1.teams.teamId.workday-tests.runId',
	updateWorkdayTestRun: 'patch.v1.teams.teamId.workday-tests.runId',
	workdayTestEvents: 'get.v1.teams.teamId.workday-tests.runId.events',
	createWorkdayTestEvent: 'post.v1.teams.teamId.workday-tests.runId.events',
