export function installCommerceSalesFulfillmentAndProductCatalogRoutes(context: any) {
	const { app, applyCommerceRefundState, commerceErrorResponse, config, createHash, ensurePrincipal, jsonError, optionalTrimmedString, principalIsSeedAdmin, processCommerceStripeWebhook, randomUUID, remainingRefundableAmount, requireCommerceProductAccess, requireSellerTeamAccess, requireTeamAccess, requireVendorOrderManager, resolveFulfillmentArtifact, resolveOrderItemForRefund, resolveStripeEnvironment, resolveStripeWebhookSecret, runtime, store, stripeConnectService, stripeRefundStatus } = context;
