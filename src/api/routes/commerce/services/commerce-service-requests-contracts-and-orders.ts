export function installCommerceServiceRequestsContractsAndOrdersRoutes(context: any) {
	const { app, capacity, commerceErrorResponse, createCommerceCheckoutRunForServiceContract, ensurePrincipal, jsonError, optionalTrimmedString, principalIsSeedAdmin, redactCommerceServiceRequestForBuyer, requireSellerTeamAccess, requireServiceBuyerAccess, requireServiceParticipantAccess, requireServiceSellerAccess, requireTeamAccess, store, stripeConnectService } = context;
