export function installCommerceVendorOnboardingStripeAndCheckoutRoutes(context: any) {
	const { app, commerceErrorResponse, config, createCommerceCheckoutRun, ensurePrincipal, jsonError, normalizeCheckoutQuantity, optionalTrimmedString, principalIsSeedAdmin, publicPaymentGroups, refreshCommercePaymentGroupState, refreshCommerceStripeAccount, requireCommerceVendorForStripe, requireTeamAccess, resolveStripeEnvironment, resolveStripePublishableKey, runtime, store, stripeAccountMissingError, stripeAccountToConnectedAccountPatch, stripeCommerceUrl, stripeConfiguredError, stripeConnectService, updateCheckoutCompletionFromGroup } = context;
