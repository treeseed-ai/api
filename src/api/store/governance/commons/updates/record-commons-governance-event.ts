...
import { isoNow,ControlPlaneStore,serializeCommonsGovernanceEvent,stringValue } from "../../../../persistence/store.ts";
export async function recordCommonsGovernanceEventMethod(this: ControlPlaneStore, input: any = {}) {
