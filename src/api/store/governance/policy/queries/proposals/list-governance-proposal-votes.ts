import { MarketControlPlaneStore,serializeGovernanceVote } from "../../../../../persistence/store.ts";
export async function listGovernanceProposalVotesMethod(this: MarketControlPlaneStore, proposalId, options: any = {}) {
