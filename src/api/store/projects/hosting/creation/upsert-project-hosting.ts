...
export async function upsertProjectHostingMethod(this: MarketControlPlaneStore, projectId, input) {
    ...
    if (existing) {
        await this.run(`UPDATE project_hosting
        ...
        await this.run(`INSERT INTO project_hosting (
