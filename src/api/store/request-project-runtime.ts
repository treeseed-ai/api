...
export async function requestProjectRuntimeMethod(this: MarketControlPlaneStore, projectId, principal, path, input: any = {}) {
    await this.ensureInitialized();
    const fetchImpl = typeof this.config.fetchImpl === 'function' ? this.config.fetchImpl as typeof fetch : fetch;
