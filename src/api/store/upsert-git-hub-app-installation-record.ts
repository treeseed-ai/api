...
export async function upsertGitHubAppInstallationRecordMethod(this: MarketControlPlaneStore, input: any = {}) {
    ...
    await this.run(`INSERT INTO github_app_installation_records (
