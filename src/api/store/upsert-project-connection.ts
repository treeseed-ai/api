...
export async function upsertProjectConnectionMethod(this: MarketControlPlaneStore, projectId, input) {
    ...
    if (!existing) {
        ...
        await this.run(`INSERT INTO project_connections (
        ...
        await this.run(`UPDATE project_connections
