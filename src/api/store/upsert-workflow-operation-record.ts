...
export async function upsertWorkflowOperationRecordMethod(this: MarketControlPlaneStore, input: any = {}) {
    ...
    if (!validation.ok)
        throw secretCapabilityValidationError(validation.problems, 'Invalid workflow operation record.');
    const timestamp = isoNow();
    await this.run(`INSERT INTO workflow_operation_records (
