...
import { installFoundationHealthMarketAndFeedbackRoutes } from '../routes/support/foundation-health-market-and-feedback.ts';
...
import { installFoundationIssueTreeDxGitHubCredentialRoutes } from '../routes/support/foundation-issueTreeDxGitHubCredential.ts';
...
import { installTeamsRepositoryAndWebHostsRoutes } from '../routes/teams/teams-repository-and-web-hosts.ts';
import { installProjectsSecretsWorkflowsAndCollectionRoutes } from '../routes/projects/secrets/projects-secrets-workflows-and-collection.ts';
import { installProjectsTeamsItemProjectsLaunchRoutes } from '../routes/projects/launch/projects-teams-item-projects-launch.ts';
import { installProjectsHostsAndRepositoryTopologyRoutes } from '../routes/projects/repositories/projects-hosts-and-repository-topology.ts';
import { installFoundationQueueProjectHostOperationRoutes } from '../routes/support/foundation-queueProjectHostOperation.ts';
import { installProjectsHostLifecycleAndSummaryRoutes } from '../routes/projects/hosting/projects-host-lifecycle-and-summary.ts';
import { installProjectsWorkstreamsAndReleasesRoutes } from '../routes/projects/delivery/projects-workstreams-and-releases.ts';
...
import { installProjectsOperationGrantsAndPlanningRoutes } from '../routes/capacity/allocations/projects-operation-grants-and-planning.ts';
...
import { installProjectsSharingHostingAndResourcesRoutes } from '../routes/projects/hosting/projects-sharing-hosting-and-resources.ts';
import { installFoundationRoutesRoutes } from '../routes/support/foundation-routes.ts';
import { installProjectsCapabilitiesContentAndCiRoutes } from '../routes/projects/access/projects-capabilities-content-and-ci.ts';
import { installOperationsProjectsItemCiJobsItemRoutes } from '../routes/projects/operations/operations-projects-item-ci-jobs-item.ts';
import { installProjectsProjectsItemDispatchRoutes } from '../routes/projects/projects-projects-item-dispatch.ts';
import { installOperationsProjectJobsAndCredentialSessionsRoutes } from '../routes/projects/operations/operations-project-jobs-and-credential-sessions.ts';
...
import { installOperationsProjectRunnerEventsAndCompletionRoutes } from '../routes/projects/operations/operations-project-runner-events-and-completion.ts';
...
import { installCatalogTemplatesAndKnowledgePacksRoutes } from '../routes/commerce/catalog/catalog-templates-and-knowledge-packs.ts';
...
export function createPlatformApiApp(options: any = {}): ReturnType<typeof createSdkApiApp> {
