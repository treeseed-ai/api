import {
	...
	type TreeDxCredentialBridgeCredential,
	type TreeDxCredentialBridgeRequest,
...
export function createTreeDxCredentialBridge(options: {
	...
	async function issueGitCredential(input: TreeDxCredentialBridgeRequest): Promise<TreeDxCredentialBridgeCredential> {
