...
function localApiConfig(projectRoot, env = process.env) {
	...
	return {
		...
		webAssertionSecret: localEnv.TREESEED_API_WEB_ASSERTION_SECRET ?? localEnv.TREESEED_WEB_ASSERTION_SECRET ?? 'treeseed-local-seed-assertion-secret',
