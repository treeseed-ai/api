...
describe('API deploy workflow', () => {
	...
	it('owns API reconciliation, live verification, runner smoke, and acceptance', () => {
		...
		expect(deployRun).toContain('npm rebuild @treeseed/sdk @treeseed/cli --workspaces=false');
		expect(deployRun).toContain('./node_modules/.bin/trsd --help >/dev/null');
		expect(deployRun).toContain('./node_modules/.bin/trsd secrets:unlock');
		...
		expect(deployRun).toContain('./node_modules/.bin/trsd hosting plan');
		...
		expect(deployRun).toContain('./node_modules/.bin/trsd hosting apply');
		expect(deployRun).toContain('--app api --json');
		...
		expect(liveRun).toContain('npm rebuild @treeseed/sdk @treeseed/cli --workspaces=false');
		expect(liveRun).toContain('./node_modules/.bin/trsd --help >/dev/null');
		expect(liveRun).toContain('./node_modules/.bin/trsd secrets:unlock');
		expect(liveRun).not.toContain('@treeseed/cli/src/cli/main.ts');
		...
		expect(liveRun).toContain('./node_modules/.bin/trsd hosting verify');
		...
		expect(liveRun).toContain('./node_modules/.bin/trsd operations smoke');
