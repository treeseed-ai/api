...
describe('project inventory access',()=>{
	it('lets a api administrator discover the complete project inventory',async()=>{
		...
		const projects=await listProjectsForPrincipalMethod.call(store as never,{id:'acceptance',roles:['platform_admin']});
